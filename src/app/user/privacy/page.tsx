      ...
      <main className="w-full pb-12">
        ...
        <div className="px-4">
          <p className="text-body-3-m mt-4 text-indigo-300">
            모멘티(Momenty)는 개인정보 보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한
          ...
          <p className="text-body-3-m mt-2 text-indigo-300">
            모멘티는 다음의 목적을 위해 개인정보를 수집하고 이용합니다.
          </p>
          <ul>
          ...
          <p className="text-body-3-m mt-2 text-indigo-300">
            모멘티는 원칙적으로 이용자의 개인정보를 외부에 제공하지 않습니다. 다만, 다음의 경우에는 예외로 합니다.
          </p>
          <ul>
          ...
          <p className="text-body-3-m mt-2 text-indigo-300">
            모멘티는 개인정보 처리에 관한 업무를 총괄하고, 개인정보 관련 문의 사항에 대해 신속하게 답변드릴 수 있도록
