  ...
  return (
    ...
    >
      <div className="flex flex-col pt-[16px] gap-[16px]">
        ...
        <div className="px-[24px]">
          <input className="flex w-full h-[60px] border-b-[4px] border-[#5A6B7F] bg-[#F4F6F9] rounded-none" />
        </div>
      </div>
      <div className={`${keyboardHeight > 0 ? '' : 'px-[24px]'}`}>
        <button
          onClick={onNext}
          className={`w-full flex justify-center items-center bg-[#021730] text-[#F4F6F9] py-[14px] text-body-1-b h-[56px] ${
